...
//============================================================================= 
SYSTEM_EXTERN volatile unsigned char XDATA wifi_queue_buf[PROTOCOL_HEAD + WIFI_UART_QUEUE_LMT];  //串口队列缓存
...
SYSTEM_EXTERN volatile unsigned char XDATA stop_update_flag;
