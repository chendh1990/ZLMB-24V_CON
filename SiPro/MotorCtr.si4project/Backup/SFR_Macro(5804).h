...
//**** P3S		ACH PAGE1 **** SFRS must set as 1 to modify self register  
...
//**** P3SR		ADH PAGE1 **** SFRS must set as 1 to modify self register  
...
//**** P0S	B2H PAGE1 **** SFRS must set as 1 to modify self register  
...
//**** P0SR		B0H PAGE1 **** SFRS must set as 1 to modify self register  
...
//**** P1S B3H PAGE1 **** SFRS must set as 1 to modify self register  
...
//**** P1SR		B4H PAGE1 **** SFRS must set as 1 to modify self register  
...
//**** PWMINTC B7H PAGE1 **** SFRS must set as 1 to modify self register  
...
//**** PWM4H	C4H	PAGE1 **** SFRS must set as 1 to modify self register  
//**** RL3		C5H PAGE0 ****
//**** PWM5H	C5H PAGE1 **** SFRS must set as 1 to modify self register  
//**** RH3		C6H PAGE0 ****

//**** PIOCON1 C6H PAGE1 **** SFRS must set as 1 to modify self register  
...
//**** RCMP2L CBH ****
//**** TL2		CCH PAGE0 ****
//**** PWM4L 	CCH PAGE1 **** SFRS must set as 1 to modify self register  
//**** TH2		CDH PAGE0 ****
//**** PWM5L	CDH PAGE1 **** SFRS must set as 1 to modify self register  
//**** ADCMPL	CEH **** 
//**** ADCMPH	CFH ****
...
//**** SPCR2		F3H PAGE1 **** SFRS must set as 1 to modify self register  
